...
// PESAN GW : GW CUMA FIX VITUR ERROR NEXT 
//              BAKALAN TAMBAHIN FITUR LAGI
///--------------------------------------------------------------\\\
...
try {
        ...
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "R-BOT", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
key: {
			fromMe: false,
			participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6281515589573@s.whatsapp.net" } : {})
		},
		message: {
			"productMessage": {
				"product": {
...
/// VIEW ONCE VID
const foncevid = { 
key: {fromMe: false, remoteJid: "6281515589573@g.us", participant: '0@s.whatsapp.net'}, 
message: { 
  videoMessage: { 
  viewOnce: true
},
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `Developed by RamaGans`, //Kasih namalu
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "R-BOT", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "R-BOT", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
_❖ Total Hit : ${cmhit.length}_
_❖ Command : ${prefix + command}_
_❖ Nama Bot : ${NamaBot}_
_❖ Nama Owner : ${NamaOwner}_
_❖ Nomor Owner : @${otod.split('@')[0]}_
_❖ Auto Composing : ${autocomposing}_
_❖ Auto Recording : ${autorecording}_
...
_*${sym}━━「 MAIN MENU 」*_
 _${rm} ${prefix}menu_
 _${rm} ${prefix}command_
 _${rm} ${prefix}caramenggunakanbot_
  
_*${sym}━━「 MENU OWNER 」*_
 _${rm} ${prefix}stopjadibot_
 _${rm} ${prefix}autorespon [ _on/off_ ]_
 _${rm} ${prefix}antidelete [ _on/off_ ]_
 _${rm} ${prefix}autoread [ _on/off_ ]_
 _${rm} ${prefix}fakevn [ _on/off_ ]_
 _${rm} ${prefix}fakengetik [ _on/off_ ]_
 _${rm} ${prefix}bc [ _teks/reply gif/image/video with caption_ ]_
 _${rm} ${prefix}tobc [ _reply sticker/audio with caption_ ]_
 _${rm} ${prefix}return [ _javascript_ ]_
 _${rm} ${prefix}clearall_
 _${rm} ${prefix}delchat_
 _${rm} ${prefix}mute_
 _${rm} ${prefix}unmute_
 _${rm} ${prefix}public_
 _${rm} ${prefix}self_
 _${rm} ${prefix}spam [ _teks|jumlah_ ]_
 _${rm} ${prefix}demoteall_
 _${rm} ${prefix}promoteall_
 _${rm} ${prefix}addcmd [ _teks reply stc_ ]_
 _${rm} ${prefix}delcmd [ _reply stc_ ]_
 _${rm} ${prefix}listcmd_
 _${rm} ${prefix}spamsw [ _teks|jumlah_ ]_
 _${rm} ${prefix}upswteks [ _teks_ ]_
 _${rm} ${prefix}upswlokasi [ _teks_ ]_
 _${rm} ${prefix}upswaudio [ _reply audio_ ]_
 _${rm} ${prefix}upswvoice [ _reply audio_ ]_
 _${rm} ${prefix}upswsticker [ _reply sticker_ ]_
 _${rm} ${prefix}upswimage [ _reply image with caption_ ]_
 _${rm} ${prefix}upswgif [ _reply gif with caption_ ]_
 _${rm} ${prefix}upswvideo [ _reply video with caption_ ]_
 _${rm} ${prefix}shutdown_
 _${rm} ${prefix}offline [ _alasan_ ]_
 _${rm} ${prefix}online_
 _${rm} ${prefix}exif [ _nama|author_ ]_
 _${rm} ${prefix}setprofile [ _reply image_ ]_
 _${rm} ${prefix}setname [ _teks_ ]_
 _${rm} ${prefix}setprefix [ _multi/nopref/allpref/teks_ ]_
 _${rm} ${prefix}setbio [ _teks_ ]_
 _${rm} ${prefix}addsticker [ _nama_ ]_
 _${rm} ${prefix}delsticker [ _nama_ ]_
 _${rm} ${prefix}addvn [ _nama_ ]_
 _${rm} ${prefix}delvn [ _nama_ ]_
 _${rm} ${prefix}addimage [ _nama_ ]_
 _${rm} ${prefix}delimage [ _nama_ ]_
 _${rm} ${prefix}bug [ _jumlah_ ]_
 _${rm} ${prefix}bugpc2 [ _jumlah_ ]_
 _${rm} ${prefix}bugtroli2 [ _jumlah_ ]_
 _${rm} ${prefix}bugpc_
 _${rm} ${prefix}bugcombine_
 _${rm} ${prefix}bugtroli_
 _${rm} ${prefix}buglokasi_
 _${rm} ${prefix}bughole_
 _${rm} ${prefix}leave_
 _${rm} ${prefix}restart_
 _${rm} ${prefix}join [ _link group_ ]_
 _${rm} ${prefix}addrespon [ _tanya|jawab_ ]_
 _${rm} ${prefix}delrespon [ _nama_ ]_
 _${rm} ${prefix}listrespon_
 
 *${sym}━「 MENU DOWNLOAD 」*_
 _${rm} ${prefix}herolist_
 _${rm} ${prefix}herodetail [ _hero_ ]_
 _${rm} ${prefix}google [ _search_ ]_
 _${rm} ${prefix}gimage [ _search_ ]_
 _${rm} ${prefix}wiki [ _search_ ]_
 _${rm} ${prefix}mediafire [ _link_ ]_
 _${rm} ${prefix}ytsearch [ _judul_ ]_
 _${rm} ${prefix}ytmp4 [ _link yt_ ]_
 _${rm} ${prefix}ytmp3 [ _link yt_ ]_
 _${rm} ${prefix}play [ _judul lagu_ ]_
 _${rm} ${prefix}video [ _judul video_ ]_
 _${rm} ${prefix}tinyurl [ _link_ ]_
 _${rm} ${prefix}fetch [ _link_ ]_
 _${rm} ${prefix}igdl [ _link_ ]_
 _${rm} ${prefix}tiktokdl [ _link_ ]_
 _${rm} ${prefix}pinterest [ _search_ ]_
 _${rm} ${prefix}lirik [ _judul_ ]_
 _${rm} ${prefix}video_
 _${rm} ${prefix}tourl [ _reply image/video_ ]_
 _${rm} ${prefix}kalkulator [ _angka_ ]_
 _${rm} ${prefix}translate [ _teks kodebhs_ ]_
 _${rm} ${prefix}ss [ _link_ ]_
 
 _*${sym}━「 MENU GROUP 」*_
 _${rm} ${prefix}getpict [ _@tag_ ]_
 _${rm} ${prefix}getname [ _reply target_ ]_
 _${rm} ${prefix}getbio [ _reply target_ ]_
 _${rm} ${prefix}promote [ _@tag_ ]_
 _${rm} ${prefix}demote [ _@tag_ ]_
 _${rm} ${prefix}antilink [ _1/0_ ]_
 _${rm} ${prefix}antibug [ _1/0_ ]_
 _${rm} ${prefix}creategrup [ _nama|@tag_ ]_
 _${rm} ${prefix}tictactoe [ _@tag_ ]_
 _${rm} ${prefix}delttt_
 _${rm} ${prefix}getpp_
 _${rm} ${prefix}kick [ _@tag_ ]_
 _${rm} ${prefix}add [ _nomor_ ]_
 _${rm} ${prefix}getdeskgc_
 _${rm} ${prefix}sider [ _reply pesan bot_ ]_
 _${rm} ${prefix}hacked [ _teks_ ]_
 _${rm} ${prefix}setnamegc [ _teks_ ]_
 _${rm} ${prefix}setdeskgc [ _teks_ ]_
 _${rm} ${prefix}fitnah [ _@tag|teks1|teks2_ ]_
 _${rm} ${prefix}kontak [ _@tag|nama_ ]_
 _${rm} ${prefix}kontag [ _@tag|nama_ ]_
 _${rm} ${prefix}opengc_
 _${rm} ${prefix}closegc_
 _${rm} ${prefix}resetlinkgc_
 _${rm} ${prefix}linkgrup_
 _${rm} ${prefix}hidetag [ _teks_ ]_
 _${rm} ${prefix}sticktag [ _nama sticker_ ]_
 _${rm} ${prefix}totag [ _reply media_ ]
 
 _*${sym}━「 MENU MAKER 」*_
 _${rm} ${prefix}matrix [ _teks_ ]_
 _${rm} ${prefix}galaxy [ _teks_ ]_
 _${rm} ${prefix}skeleton [ _teks_ ]_
 _${rm} ${prefix}3dstone [ _teks_ ]_
 _${rm} ${prefix}thunder [ _teks_ ]_
 _${rm} ${prefix}denim [ _teks_ ]_
 _${rm} ${prefix}halloween [ _teks_ ]_
 _${rm} ${prefix}blood [ _teks_ ]_
 _${rm} ${prefix}metaldark [ _teks_ ]_
 _${rm} ${prefix}warrior [ _teks_ ]_
 
 _*${sym}━「 MENU OTHER 」*_
 _${rm} ${prefix}jadibot_
 _${rm} ${prefix}caripesan [ _teks|jumlah_ ]_
 _${rm} ${prefix}slots_
 _${rm} ${prefix}suit [ _gunting/batu/kertas_ ]_
 _${rm} ${prefix}tag [ _nomor_ ]_
 _${rm} ${prefix}tagme_
 _${rm} ${prefix}tts [ _kodebhs teks_ ]_
 _${rm} ${prefix}readmore [ _teks1|teks2_ ]_
 _${rm} ${prefix}fitnahpc [ _nomor|teks1|teks2_ ]_
 _${rm} ${prefix}chat [ _nomor|teks_ ]_
 _${rm} ${prefix}fdeface [ _replyimg link|teks1|teks2_ ]_
 _${rm} ${prefix}listimage_
 _${rm} ${prefix}liststicker_
 _${rm} ${prefix}listvn_
 _${rm} ${prefix}listgrup_
 _${rm} ${prefix}baileys [ _reply message_ ]_
 _${rm} ${prefix}q [ _reply message_ ]_
 _${rm} ${prefix}getcaption [ _reply message_ ]_
 _${rm} ${prefix}pantun_
 _${rm} ${prefix}tospam [ _reply audio/sticker/image|jumlah_ ]_
 _${rm} ${prefix}sharelock [ _teks1|teks2_ ]_
 _${rm} ${prefix}sticker_
 _${rm} ${prefix}stickerwm [ _nama|author_ ]_
 _${rm} ${prefix}takestick [ _nama|author_ ]_
 _${rm} ${prefix}colong [ _reply sticker_ ]_
 _${rm} ${prefix}dadu_
 _${rm} ${prefix}semoji [ _emoji_ ]_
 _${rm} ${prefix}attp [ _teks_ ]_
 _${rm} ${prefix}toimg_
 _${rm} ${prefix}tomp3 [ _reply video_ ]_
 _${rm} ${prefix}tomp4 [ _reply sticker gif_ ]_
 _${rm} ${prefix}robot [ _reply audio_ ]_
 _${rm} ${prefix}balik [ _reply audio_ ]_
 _${rm} ${prefix}bass [ _reply audio_ ]_
...
sendButDocument(from, `${menu}`, "C R E A T E B Y R A M A G A N S",  fs.readFileSync('./sampah/Denpa'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./media/image/banner.jpg'), filename:`${jmn} - ${week} - ${calender}`}, [{buttonId:``,buttonText:{displayText:'S&k \n\nSebenar nya saya itu. suka ngegay diam diam kalo ada yg minat ngegay sama saya silahkan pc ya muach😘😘'},type:1}], {quoted:fmen, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} ${pushname}`,body:`*click here to play music`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/uQiF1yOnzDg`}}})
lima = fs.readFileSync('./help.mp3');
denz.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'command':
 stod = `${sender}`
 listMsg = {
...
menu = `_*${sym}━「 MENU GROUP 」*_
 ...
 _${rm} ${prefix}hidetag [ _teks_ ]_
 _${rm} ${prefix}sticktag [ _nama sticker_ ]_
 _${rm} ${prefix}totag [ _reply media_ ]_`
katalog(menu)
break
case 'othermenu':
menu = `_*${sym}━「 MENU OTHER 」*_
 _${rm} ${prefix}jadibot_
 _${rm} ${prefix}caripesan [ _teks|jumlah_ ]_
 _${rm} ${prefix}slots_
 _${rm} ${prefix}suit [ _gunting/batu/kertas_ ]_
 ...
 _${rm} ${prefix}gemuk [ _reply audio_ ]_
 _${rm} ${prefix}detikvn [ _reply audio caption angka_ ]_
 _${rm} ${prefix}detikvideo [ _reply video caption angka_ ]_`
katalog(menu)
break
case 'jadibot':
client.version = [2, 2119, 6]
client.browserDescription = ['RamaGans','Desktop','3.0']
      ...
      if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
       if (args.length < 1) return sendButMessage(from, `\`\`\`「 PREFIX SETTING 」\`\`\``, `Silahkan pilih salah satu`, [
        ...
        case 'test':
				...
				break
				case 'carapenggunaan':
				case 'caramenggunakanbot':
reply(`_*🔰━━[ * ${NamaBot} * ]━━ 🔰*_
_*Hallo, ${pushname} 👋*_
_*Berikut adalah cara penggunaan*_ _*${NamaBot}*_
         ────────────────
_*Kalo gak paham tuh baca dulu*_
         ────────────────
${rm} _*${prefix}sticker*_
_*Kirim gambar/video dengan caption sticker*_
${rm} _*${prefix}tts*_
_*Suara google contoh : ${prefix}tts id Hai*_
${rm} _*${prefix}toimg*_
_*Reply sticker yang mau dijadiin image*_
${rm} _*${prefix}play*_
_*Mendownload lagu dari youtube bisa menggunakan text atau link*_
${rm} _*${prefix}ytmp3*_
_*Mendownload video dari youtube, gunakan link ya kak*_
${rm} _*${prefix}tiktok*_
_*Mendownload video tiktok, gunakan link kak*_
${rm} _*${prefix}fitnah*_
_*Only grup untuk fitnah orang, contoh : ${prefix}fitnah @tagtarget & Hai & Hai juga*_
         ────────────────
_*Note : Sisanya gunain otak kalian aja cape w jelasin :)*_
         ────────────────
🔰━━━━[ *${NamaBot}* ]━━━━🔰
`)
break
...
break				 
				case 'pantun':
				anu = await fetchJson(`https://api.zeks.me/api/pantun?apikey=${Vinz}`, {method: 'get'})
				kata = anu.result
				reply(kata)
				break				 			 					 
				case 'dadu':
...
if (Number(oi2) >= 50) return reply('Kebanyakan!')
	...
	sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/halloween?text=${arg}&apikey=${Dap}`)
   break
   case 'blood':
   if (!arg) return reply(from, `Penggunaan ${prefix}blood teks`, mek)
   sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/blood?text=${arg}&apikey=${Dap}`)
   break
case 'matrix':
				if (!arg) return reply(from, `Penggunaan ${prefix}matrix teks`, mek)
				sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/matrixstyle?text=${arg}&apikey=${Dap}`)
				break
				case 'galaxy':
				if (!arg) return reply(from, `Penggunaan ${prefix}galaxy teks`, mek)
				sendMediaURL(from, `https://api.dapuhy.ga/api/ephoto/galaxy?text=${arg}&apikey=${Dap}`)
				break
				case 'skeleton':
				if (!arg) return reply(from, `Penggunaan ${prefix}skeleton teks`, mek)
				sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/skeleton?text=${arg}&apikey=${Dap}`)
				break
				case '3dstone':
				if (!arg) return reply(from, `Penggunaan ${prefix}3dstone teks`, mek)
				sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/3dstone?text=${arg}&apikey=${Dap}`)
				break
				case 'thunder':
				if (!arg) return reply(from, `Penggunaan ${prefix}thunder teks`, mek)
				sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/thunder?text=${arg}&apikey=${Dap}`)
				break
				case 'denim':
				if (!arg) return reply(from, `Penggunaan ${prefix}denim teks`, mek)
				sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/denim?text=${arg}&apikey=${Dap}`)
				break
				case 'metaldark':
				if (!arg) return reply(from, `Penggunaan ${prefix}metaldark teks`, mek)
				sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/metaldark?text=${arg}&apikey=${Dap}`)
				break
				case 'lionlogo':
				if (!arg) return reply(from, `Penggunaan ${prefix}warrior teks`, mek)
				sendMediaURL(from, `https://api.dapuhy.ga/api/textpro/magmahot?text=${arg}&apikey=${Dap}`)
				break
				case 'd':
				case 'del':
				case 'delete':
                ...
                case 'ytmp4':
						...
						try {
							...
							.then((res) => {
								...
								.then((a) => {
								if (Number(filesize) >= 40000) return sendMediaURL(from, thumb, `${sym} *YTmp4*\n\n${sym} *Title* : ${title}\n${sym} *Ext* : MP3\n*Filesize* : ${filesizeF}\n*Link* : ${a.data}\n\n_Maaf durasi melebihi batas maksimal, Silahkan klik link diatas_`)
...
┗ ${prefix}ytmp4 [link yt] = Video`})
            ...
            break
				      	case 'play': case 'song':
									...
									if (!c) return reply(`Example : ${prefix+command} query`)
									reply(mess.wait)
									try {
										var srch = args.join(' ')
										...
										.then((res) => {
											...
											axios.get(`https://tinyurl.com/api-create.php?url=${dl_link}`)
											.then((a) => {
												if (Number(filesize) >= 40000) return denz.sendMessage(from, `*─ 「 YOUTUBE VIDEO 」─*\n\n*▢ Title :* ${title}\n*▢ Filesize :* ${filesizeF}\n*▢ Upload :* ${yut.videos[0].ago}\n*▢ Ditonton :* ${yut.videos[0].views}\n*▢ Duration :* ${yut.videos[0].timestamp}\n\n\`\`\`Ukuran File Terlalu Besar Jadi Di Sajikan Dalam Bentuk Link\`\`\``, text, {quoted : mek})
												denz.sendMessage(from, thumb, image, {caption: `─ 「 YOUTUBE VIDEO 」─\n\n*▢ Title :* ${title}\n*▢ Filesize :* ${filesizeF}\n*▢ Upload :* ${yut.videos[0].ago}\n*▢ Ditonton :* ${yut.videos[0].views}\n*▢ Duration :* ${yut.videos[0].timestamp}\n*▢ LINK :* ${yut.videos[0].url}\n\n\`\`\`Tunggu Sebentar, Video Sedang Dikirim\`\`\``, quoted : mek})
			...
			case 'ping':
				...
				case 'tomedia':
					...
					break
				case 'ss':
					sendMediaURL(from, `https://api.dapuhy.ga/api/others/ssweb?url=${args[0]}&apikey=${Dap}`)
					break
				break
				case 'addsticker':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
teks += `${sym} *Tanya:* ${commandsDB[i].pesan}\n`
teks += `${sym} *Balasan:* ${commandsDB[i].balasan}\n`
teks += `${sym} *Creator:* ${commandsDB[i].creator}\n\n`
}
reply(teks)
break
default:break
